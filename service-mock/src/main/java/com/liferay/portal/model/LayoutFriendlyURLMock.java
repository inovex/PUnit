 ...
 * 
 */
public class LayoutFriendlyURLMock
    extends MockService<LayoutFriendlyURL>
    implements LayoutFriendlyURL
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.model.LayoutFriendlyURL.class));
    }
    ...
    public int compareTo(LayoutFriendlyURL param0) {
    ...
    public long getLayoutFriendlyURLId() {
        return this.mockObject.getLayoutFriendlyURLId();
    }

    public void setLayoutFriendlyURLId(long param0) {
    }
