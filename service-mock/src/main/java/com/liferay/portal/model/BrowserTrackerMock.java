 ...
 * 
 */
public class BrowserTrackerMock
    extends MockService<BrowserTracker>
    implements BrowserTracker
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.model.BrowserTracker.class));
    }
    ...
    public int compareTo(BrowserTracker param0) {
    ...
    public long getBrowserKey() {
        return this.mockObject.getBrowserKey();
    }
