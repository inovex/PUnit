 ...
 * 
 */
public class ShardMock
    extends MockService<Shard>
    implements Shard
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.model.Shard.class));
    }
    ...
    public int compareTo(Shard param0) {
    ...
    public long getShardId() {
        return this.mockObject.getShardId();
    }

    public void setShardId(long param0) {
    }
