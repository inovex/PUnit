 ...
 * 
 */
public class ResourceBlockPermissionMock
    extends MockService<ResourceBlockPermission>
    implements ResourceBlockPermission
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.model.ResourceBlockPermission.class));
    }
    ...
    public int compareTo(ResourceBlockPermission param0) {
    ...
    public long getResourceBlockPermissionId() {
        return this.mockObject.getResourceBlockPermissionId();
    }
