...
public class RepositoryMock
    extends MockService<Repository>
    implements Repository
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.model.Repository.class));
    }
    ...
    public int compareTo(Repository param0) {
    ...
    public long getDlFolderId() {
        return this.mockObject.getDlFolderId();
    }

    public void setDlFolderId(long param0) {
    }
