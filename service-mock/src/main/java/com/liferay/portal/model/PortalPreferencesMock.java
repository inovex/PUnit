 ...
 * 
 */
public class PortalPreferencesMock
    extends MockService<PortalPreferences>
    implements PortalPreferences
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.model.PortalPreferences.class));
    }
    ...
    public int compareTo(PortalPreferences param0) {
    ...
    public long getPortalPreferencesId() {
        return this.mockObject.getPortalPreferencesId();
    }
