...
public class PermissionMock
    extends MockService<Permission>
    implements Permission
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.model.Permission.class));
    }
    ...
    public int compareTo(Permission param0) {
    ...
    public long getPermissionId() {
        return this.mockObject.getPermissionId();
    }

    public void setPermissionId(long param0) {
    }
