 ...
 * 
 */
public class ResourceCodeMock
    extends MockService<ResourceCode>
    implements ResourceCode
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.model.ResourceCode.class));
    }
    ...
    public int compareTo(ResourceCode param0) {
