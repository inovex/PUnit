 ...
 * 
 */
public class PortletItemMock
    extends MockService<PortletItem>
    implements PortletItem
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.model.PortletItem.class));
    }
    ...
    public int compareTo(PortletItem param0) {
