 ...
 * 
 */
public class ResourceTypePermissionMock
    extends MockService<ResourceTypePermission>
    implements ResourceTypePermission
{
    ...
    public int compareTo(ResourceTypePermission param0) {
