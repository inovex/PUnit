...
public class SubscriptionMock
    extends MockService<Subscription>
    implements Subscription
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.model.Subscription.class));
    }
    ...
    public int compareTo(Subscription param0) {
    ...
    public void setSubscriptionId(long param0) {
    }

    public void setFrequency(String param0) {
    }

    public String getFrequency() {
        return this.mockObject.getFrequency();
    }

    public long getSubscriptionId() {
        return this.mockObject.getSubscriptionId();
    }
