    ...
    implements PhoneLocalService
{
    ...
    public Phone fetchPhoneByUuidAndCompanyId(String param0, long param1)
        throws SystemException
    {
        return this.mockObject.fetchPhoneByUuidAndCompanyId(param0, param1);
    }
    ...
    public Phone getPhoneByUuidAndCompanyId(String param0, long param1)
        throws PortalException, SystemException
    {
        return this.mockObject.getPhoneByUuidAndCompanyId(param0, param1);
    }
    ...
    public Phone addPhone(long param0, String param1, long param2, String param3, String param4, int param5, boolean param6, ServiceContext param7)
        throws PortalException, SystemException
    {
        return this.mockObject.addPhone(param0, param1, param2, param3, param4, param5, param6, param7);
    }
