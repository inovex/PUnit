    ...
    implements LayoutLocalService
{
    ...
    public Layout updateFriendlyURL(long param0, String param1)
        throws PortalException, SystemException
    {
    ...
    public Layout getLayoutByUuidAndGroupId(String param0, long param1)
        throws PortalException, SystemException
    {
        return this.mockObject.getLayoutByUuidAndGroupId(param0, param1);
    }
    ...
    public Layout updateLayout(Layout param0, boolean param1)
        throws SystemException
    {
        return this.mockObject.updateLayout(param0, param1);
    }
    ...
    public Layout fetchLayoutByUuidAndGroupId(String param0, long param1)
        throws SystemException
    {
        return this.mockObject.fetchLayoutByUuidAndGroupId(param0, param1);
    }
    ...
    public boolean hasLayoutSetPrototypeLayout(String param0, String param1)
        throws PortalException, SystemException
    {
        return this.mockObject.hasLayoutSetPrototypeLayout(param0, param1);
    }
