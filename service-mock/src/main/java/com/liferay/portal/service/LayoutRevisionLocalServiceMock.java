    ...
    implements LayoutRevisionLocalService
{
    ...
    public LayoutRevision fetchLayoutRevision(long param0, boolean param1, long param2)
        throws SystemException
    {
        return this.mockObject.fetchLayoutRevision(param0, param1, param2);
    }
    ...
    public List<LayoutRevision> getLayoutRevisions(long param0, long param1, int param2, int param3, OrderByComparator param4)
        throws SystemException
    {
        return this.mockObject.getLayoutRevisions(param0, param1, param2, param3, param4);
    }
