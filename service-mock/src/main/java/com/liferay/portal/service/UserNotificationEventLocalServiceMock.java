 ...
 * 
 */
public class UserNotificationEventLocalServiceMock
    extends MockService<UserNotificationEventLocalService>
    implements UserNotificationEventLocalService
{

    private HashMap<Long, UserNotificationEvent> _serviceObjects = new HashMap<Long, UserNotificationEvent>();

    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.service.UserNotificationEventLocalService.class));
    }
    ...
    public UserNotificationEvent addUserNotificationEvent(long param0, NotificationEvent param1)
        throws PortalException, SystemException
    {
        return this.mockObject.addUserNotificationEvent(param0, param1);
    }

    public UserNotificationEvent addUserNotificationEvent(long param0, String param1, long param2, long param3, String param4, boolean param5, ServiceContext param6)
        throws PortalException, SystemException
    {
    ...
    public UserNotificationEvent deleteUserNotificationEvent(UserNotificationEvent param0)
        throws SystemException
    {
        return this.mockObject.deleteUserNotificationEvent(param0);
    }
    ...
    public UserNotificationEvent fetchUserNotificationEvent(long param0)
        throws SystemException
    {
    ...
    public List<UserNotificationEvent> getUserNotificationEvents(long param0)
        throws SystemException
    {
