    ...
    implements EmailAddressLocalService
{
    ...
    public EmailAddress fetchEmailAddressByUuidAndCompanyId(String param0, long param1)
        throws SystemException
    {
        return this.mockObject.fetchEmailAddressByUuidAndCompanyId(param0, param1);
    }
    ...
    public EmailAddress addEmailAddress(long param0, String param1, long param2, String param3, int param4, boolean param5, ServiceContext param6)
        throws PortalException, SystemException
    {
        return this.mockObject.addEmailAddress(param0, param1, param2, param3, param4, param5, param6);
    }
    ...
    public EmailAddress getEmailAddressByUuidAndCompanyId(String param0, long param1)
        throws PortalException, SystemException
    {
        return this.mockObject.getEmailAddressByUuidAndCompanyId(param0, param1);
    }
