 ...
 * 
 */
public class LayoutBranchLocalServiceMock
    extends MockService<LayoutBranchLocalService>
    implements LayoutBranchLocalService
{

    private HashMap<Long, LayoutBranch> _serviceObjects = new HashMap<Long, LayoutBranch>();

    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portal.service.LayoutBranchLocalService.class));
    }
    ...
    public LayoutBranch fetchLayoutBranch(long param0)
        throws SystemException
    {
        return (_serviceObjects.get(param0));
    }

    public LayoutBranch getLayoutBranch(long param0)
        throws PortalException, SystemException
    {
        return (_serviceObjects.get(param0));
    }

    public List<LayoutBranch> getLayoutBranchs(int param0, int param1)
        throws SystemException
    {
        return this.mockObject.getLayoutBranchs(param0, param1);
    }
    ...
    public List<LayoutBranch> getLayoutBranches(long param0, long param1, int param2, int param3, OrderByComparator param4)
        throws SystemException
    {
        return this.mockObject.getLayoutBranches(param0, param1, param2, param3, param4);
    }

    public List<LayoutBranch> getLayoutSetBranchLayoutBranches(long param0)
        throws SystemException
    {
