 ...
 * 
 */
public class ClassNameLocalServiceMock
    extends MockService<ClassNameLocalService>
    implements ClassNameLocalService
{

    private HashMap<Long, ClassName> _serviceObjects = new HashMap<Long, ClassName>();
    ...
    public ClassName createClassName(long param0) {
        return this.mockObject.createClassName(param0);
    }

    public ClassName deleteClassName(long param0)
        throws PortalException, SystemException
    {
        return this.mockObject.deleteClassName(param0);
    }

    public ClassName deleteClassName(ClassName param0)
        throws SystemException
    {
        return this.mockObject.deleteClassName(param0);
    }

    public ClassName fetchClassName(long param0)
        throws SystemException
    {
        return (_serviceObjects.get(param0));
    }

    public ClassName fetchClassName(String param0)
        throws SystemException
    {
        return this.mockObject.fetchClassName(param0);
    }

    public List<ClassName> getClassNames(int param0, int param1)
        throws SystemException
    {
        return this.mockObject.getClassNames(param0, param1);
    }

    public int getClassNamesCount()
        throws SystemException
    {
        return this.mockObject.getClassNamesCount();
    }

    public ClassName updateClassName(ClassName param0)
        throws SystemException
    {
