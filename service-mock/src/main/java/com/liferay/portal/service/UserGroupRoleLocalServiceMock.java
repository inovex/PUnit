    ...
    implements UserGroupRoleLocalService
{
    ...
    public void deleteUserGroupRoles(long[] param0, long param1, int param2)
        throws SystemException
    {
    }
    ...
    public List<UserGroupRole> getUserGroupRolesByGroup(long param0)
        throws SystemException
    {
        return this.mockObject.getUserGroupRolesByGroup(param0);
    }
    ...
    public List<UserGroupRole> addUserGroupRoles(long param0, long param1, long[] param2)
        throws SystemException
    {
        return this.mockObject.addUserGroupRoles(param0, param1, param2);
    }
