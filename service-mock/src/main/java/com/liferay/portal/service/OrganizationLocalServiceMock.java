    ...
    implements OrganizationLocalService
{
    ...
    public List<Organization> search(long param0, LinkedHashMap<String, Object> param1, int param2, int param3)
    ...
    public Organization updateOrganization(Organization param0, boolean param1)
        throws SystemException
    {
        return this.mockObject.updateOrganization(param0, param1);
    }
