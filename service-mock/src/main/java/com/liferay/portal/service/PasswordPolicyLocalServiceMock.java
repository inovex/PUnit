    ...
    implements PasswordPolicyLocalService
{
    ...
    public void deleteNondefaultPasswordPolicies(long param0)
        throws PortalException, SystemException
    {
    }
    ...
    public PasswordPolicy getPasswordPolicyByUuidAndCompanyId(String param0, long param1)
        throws PortalException, SystemException
    {
        return this.mockObject.getPasswordPolicyByUuidAndCompanyId(param0, param1);
    }
    ...
    public PasswordPolicy updatePasswordPolicy(long param0, String param1, String param2, boolean param3, boolean param4, long param5, boolean param6, boolean param7, int param8, int param9, int param10, int param11, int param12, int param13, String param14, boolean param15, int param16, boolean param17, long param18, long param19, int param20, boolean param21, int param22, long param23, long param24, long param25, ServiceContext param26)
        throws PortalException, SystemException
    {
        return this.mockObject.updatePasswordPolicy(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18, param19, param20, param21, param22, param23, param24, param25, param26);
    }
    ...
    public PasswordPolicy fetchPasswordPolicy(long param0, String param1)
        throws SystemException
    {
        return this.mockObject.fetchPasswordPolicy(param0, param1);
    }
    ...
    public PasswordPolicy fetchPasswordPolicyByUuidAndCompanyId(String param0, long param1)
        throws SystemException
    {
        return this.mockObject.fetchPasswordPolicyByUuidAndCompanyId(param0, param1);
    }

    public PasswordPolicy addPasswordPolicy(long param0, boolean param1, String param2, String param3, boolean param4, boolean param5, long param6, boolean param7, boolean param8, int param9, int param10, int param11, int param12, int param13, int param14, String param15, boolean param16, int param17, boolean param18, long param19, long param20, int param21, boolean param22, int param23, long param24, long param25, long param26, ServiceContext param27)
        throws PortalException, SystemException
    {
        return this.mockObject.addPasswordPolicy(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18, param19, param20, param21, param22, param23, param24, param25, param26, param27);
    }
