 ...
 * 
 */
public class AssetEntryMock
    extends MockService<AssetEntry>
    implements AssetEntry
{
    ...
    public int compareTo(AssetEntry param0) {
    ...
    public void setClassUuid(String param0) {
    }

    public long getClassTypeId() {
        return this.mockObject.getClassTypeId();
    }
    ...
    public Date getPublishDate() {
        return this.mockObject.getPublishDate();
    }

    public void setPublishDate(Date param0) {
    }
    ...
    public String getSummary(String param0) {
        return this.mockObject.getSummary(param0);
    }
    ...
    public String getSummaryCurrentLanguageId() {
        return this.mockObject.getSummaryCurrentLanguageId();
    }

    public String getSummaryCurrentValue() {
        return this.mockObject.getSummaryCurrentValue();
    }
    ...
    public void setSummaryMap(Map<Locale, String> param0) {
    }

    public void setSummaryMap(Map<Locale, String> param0, Locale param1) {
    }
