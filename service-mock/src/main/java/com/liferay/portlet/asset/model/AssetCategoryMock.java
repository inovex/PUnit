 ...
 * 
 */
public class AssetCategoryMock
    extends MockService<AssetCategory>
    implements AssetCategory
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.asset.model.AssetCategory.class));
    }
    ...
    public boolean isRootCategory() {
        return this.mockObject.isRootCategory();
    }
    ...
    public int compareTo(AssetCategory param0) {
    ...
    public long getLeftCategoryId() {
        return this.mockObject.getLeftCategoryId();
    }

    public void setLeftCategoryId(long param0) {
    }

    public long getRightCategoryId() {
        return this.mockObject.getRightCategoryId();
    }

    public void setRightCategoryId(long param0) {
    }
