 ...
 * 
 */
public class AssetCategoryPropertyMock
    extends MockService<AssetCategoryProperty>
    implements AssetCategoryProperty
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.asset.model.AssetCategoryProperty.class));
    }
    ...
    public int compareTo(AssetCategoryProperty param0) {
        return this.mockObject.compareTo(param0);
    }

    public String getValue() {
        return this.mockObject.getValue();
    }
    ...
    public long getCategoryPropertyId() {
        return this.mockObject.getCategoryPropertyId();
    }

    public void setCategoryPropertyId(long param0) {
    }
