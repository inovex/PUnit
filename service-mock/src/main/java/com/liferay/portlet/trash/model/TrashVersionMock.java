 ...
 * 
 */
public class TrashVersionMock
    extends MockService<TrashVersion>
    implements TrashVersion
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.trash.model.TrashVersion.class));
    }
    ...
    public int compareTo(TrashVersion param0) {
    ...
    public long getVersionId() {
        return this.mockObject.getVersionId();
    }

    public void setVersionId(long param0) {
    }
