 ...
 * 
 */
public class JournalArticleResourceMock
    extends MockService<JournalArticleResource>
    implements JournalArticleResource
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.journal.model.JournalArticleResource.class));
    }
    ...
    public int compareTo(JournalArticleResource param0) {
