 ...
 * 
 */
public class JournalStructureMock
    extends MockService<JournalStructure>
    implements JournalStructure
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.journal.model.JournalStructure.class));
    }

    public String getMergedXsd() {
        return this.mockObject.getMergedXsd();
    }
    ...
    public int compareTo(JournalStructure param0) {
    ...
    public void setParentStructureId(String param0) {
    }
