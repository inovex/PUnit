 ...
 * 
 */
public class JournalContentSearchMock
    extends MockService<JournalContentSearch>
    implements JournalContentSearch
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.journal.model.JournalContentSearch.class));
    }
    ...
    public int compareTo(JournalContentSearch param0) {
