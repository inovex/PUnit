 ...
 * 
 */
public class JournalTemplateMock
    extends MockService<JournalTemplate>
    implements JournalTemplate
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.journal.model.JournalTemplate.class));
    }
    ...
    public int compareTo(JournalTemplate param0) {
    ...
    public String getXsl() {
        return this.mockObject.getXsl();
    }

    public void setXsl(String param0) {
    }

    public String getLangType() {
        return this.mockObject.getLangType();
    }

    public void setLangType(String param0) {
    }
