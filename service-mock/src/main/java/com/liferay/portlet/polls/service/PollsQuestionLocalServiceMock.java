    ...
    implements PollsQuestionLocalService
{
    ...
    public PollsQuestion fetchPollsQuestionByUuidAndCompanyId(String param0, long param1)
        throws SystemException
    {
        return this.mockObject.fetchPollsQuestionByUuidAndCompanyId(param0, param1);
    }

    public PollsQuestion fetchPollsQuestionByUuidAndGroupId(String param0, long param1)
        throws SystemException
    {
        return this.mockObject.fetchPollsQuestionByUuidAndGroupId(param0, param1);
    }

    public PollsQuestion getPollsQuestionByUuidAndCompanyId(String param0, long param1)
        throws PortalException, SystemException
    {
        return this.mockObject.getPollsQuestionByUuidAndCompanyId(param0, param1);
    }
