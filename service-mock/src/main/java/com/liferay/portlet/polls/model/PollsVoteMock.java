 ...
 * 
 */
public class PollsVoteMock
    extends MockService<PollsVote>
    implements PollsVote
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.polls.model.PollsVote.class));
    }

    public PollsChoice getChoice()
        throws PortalException, SystemException
    {
        return this.mockObject.getChoice();
    }
    ...
    public int compareTo(PollsVote param0) {
    ...
    public long getVoteId() {
        return this.mockObject.getVoteId();
    }

    public void setVoteId(long param0) {
    }

    public Date getVoteDate() {
        return this.mockObject.getVoteDate();
    }

    public void setVoteDate(Date param0) {
    }
