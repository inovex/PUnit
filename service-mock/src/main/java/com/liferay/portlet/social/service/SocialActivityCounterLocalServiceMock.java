 ...
 * 
 */
public class SocialActivityCounterLocalServiceMock
    extends MockService<SocialActivityCounterLocalService>
    implements SocialActivityCounterLocalService
{

    private HashMap<Long, SocialActivityCounter> _serviceObjects = new HashMap<Long, SocialActivityCounter>();

    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.social.service.SocialActivityCounterLocalService.class));
    }
    ...
    public SocialActivityCounter deleteSocialActivityCounter(long param0)
        throws PortalException, SystemException
    {
        return this.mockObject.deleteSocialActivityCounter(param0);
    }

    public SocialActivityCounter deleteSocialActivityCounter(SocialActivityCounter param0)
        throws SystemException
    {
        return this.mockObject.deleteSocialActivityCounter(param0);
    }

    public SocialActivityCounter fetchSocialActivityCounter(long param0)
        throws SystemException
    {
        return (_serviceObjects.get(param0));
    }

    public SocialActivityCounter getSocialActivityCounter(long param0)
        throws PortalException, SystemException
    {
        return (_serviceObjects.get(param0));
    }

    public List<SocialActivityCounter> getSocialActivityCounters(int param0, int param1)
        throws SystemException
    {
        return this.mockObject.getSocialActivityCounters(param0, param1);
    }

    public int getSocialActivityCountersCount()
        throws SystemException
    {
        return this.mockObject.getSocialActivityCountersCount();
    }

    public SocialActivityCounter updateSocialActivityCounter(SocialActivityCounter param0)
        throws SystemException
    {
    ...
    public SocialActivityCounter fetchActivityCounterByEndPeriod(long param0, long param1, long param2, String param3, int param4, int param5)
        throws SystemException
    {
        return this.mockObject.fetchActivityCounterByEndPeriod(param0, param1, param2, param3, param4, param5);
    }

    public SocialActivityCounter fetchActivityCounterByStartPeriod(long param0, long param1, long param2, String param3, int param4, int param5)
        throws SystemException
    {
        return this.mockObject.fetchActivityCounterByStartPeriod(param0, param1, param2, param3, param4, param5);
    }

    public SocialActivityCounter fetchLatestActivityCounter(long param0, long param1, long param2, String param3, int param4)
        throws SystemException
    {
        return this.mockObject.fetchLatestActivityCounter(param0, param1, param2, param3, param4);
    }

    public List<SocialActivityCounter> getOffsetActivityCounters(long param0, String param1, int param2, int param3)
        throws SystemException
    {
        return this.mockObject.getOffsetActivityCounters(param0, param1, param2, param3);
    }

    public List<SocialActivityCounter> getOffsetDistributionActivityCounters(long param0, String param1, int param2, int param3)
        throws SystemException
    {
        return this.mockObject.getOffsetDistributionActivityCounters(param0, param1, param2, param3);
    }

    public List<SocialActivityCounter> getPeriodActivityCounters(long param0, String param1, int param2, int param3)
        throws SystemException
    {
