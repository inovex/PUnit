    ...
    implements SocialActivityLimitLocalService
{
    ...
    public SocialActivityLimit fetchActivityLimit(long param0, long param1, long param2, long param3, int param4, String param5)
        throws SystemException
    {
        return this.mockObject.fetchActivityLimit(param0, param1, param2, param3, param4, param5);
    }
