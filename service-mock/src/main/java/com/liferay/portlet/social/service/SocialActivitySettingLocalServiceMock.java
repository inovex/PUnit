 ...
 * 
 */
public class SocialActivitySettingLocalServiceMock
    extends MockService<SocialActivitySettingLocalService>
    implements SocialActivitySettingLocalService
{

    private HashMap<Long, SocialActivitySetting> _serviceObjects = new HashMap<Long, SocialActivitySetting>();

    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.social.service.SocialActivitySettingLocalService.class));
    }
    ...
    public List<SocialActivitySetting> getSocialActivitySettings(int param0, int param1)
        throws SystemException
    {
        return this.mockObject.getSocialActivitySettings(param0, param1);
    }

    public int getSocialActivitySettingsCount()
        throws SystemException
    {
        return this.mockObject.getSocialActivitySettingsCount();
    }

    public SocialActivitySetting updateSocialActivitySetting(SocialActivitySetting param0)
        throws SystemException
    {
    ...
    public SocialActivityDefinition getActivityDefinition(long param0, String param1, int param2)
        throws SystemException
    {
        return this.mockObject.getActivityDefinition(param0, param1, param2);
    }

    public List<SocialActivityDefinition> getActivityDefinitions(long param0, String param1)
        throws SystemException
    {
        return this.mockObject.getActivityDefinitions(param0, param1);
    }

    public List<SocialActivitySetting> getActivitySettings(long param0)
        throws SystemException
    {
