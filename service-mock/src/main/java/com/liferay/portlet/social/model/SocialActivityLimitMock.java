 ...
 * 
 */
public class SocialActivityLimitMock
    extends MockService<SocialActivityLimit>
    implements SocialActivityLimit
{
    ...
    public int compareTo(SocialActivityLimit param0) {
    ...
    public String getActivityCounterName() {
        return this.mockObject.getActivityCounterName();
    }
