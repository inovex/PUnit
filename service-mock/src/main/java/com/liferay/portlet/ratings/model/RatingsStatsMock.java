 ...
 * 
 */
public class RatingsStatsMock
    extends MockService<RatingsStats>
    implements RatingsStats
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.ratings.model.RatingsStats.class));
    }
    ...
    public int compareTo(RatingsStats param0) {
    ...
    public double getTotalScore() {
        return this.mockObject.getTotalScore();
    }

    public void setTotalScore(double param0) {
    }

    public double getAverageScore() {
        return this.mockObject.getAverageScore();
    }
