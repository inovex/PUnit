 ...
 * 
 */
public class RatingsEntryMock
    extends MockService<RatingsEntry>
    implements RatingsEntry
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.ratings.model.RatingsEntry.class));
    }
    ...
    public int compareTo(RatingsEntry param0) {
    ...
    public double getScore() {
        return this.mockObject.getScore();
    }

    public void setScore(double param0) {
    }
