    ...
    implements DDMStructureLocalService
{
    ...
    public DDMStructure fetchStructure(long param0, String param1)
        throws SystemException
    {
        return this.mockObject.fetchStructure(param0, param1);
    }
    ...
    public DDMStructure getStructure(long param0, String param1)
        throws PortalException, SystemException
    {
    ...
    public DDMStructure updateDDMStructure(DDMStructure param0, boolean param1)
        throws SystemException
    {
        return this.mockObject.updateDDMStructure(param0, param1);
    }

    public DDMStructure addStructure(long param0, long param1, long param2, String param3, Map<Locale, String> param4, Map<Locale, String> param5, String param6, String param7, int param8, ServiceContext param9)
        throws PortalException, SystemException
    {
        return this.mockObject.addStructure(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9);
    }
    ...
    public DDMStructure updateStructure(long param0, Map<Locale, String> param1, Map<Locale, String> param2, String param3, ServiceContext param4)
        throws PortalException, SystemException
    {
        return this.mockObject.updateStructure(param0, param1, param2, param3, param4);
    }

    public DDMStructure updateStructure(long param0, String param1, Map<Locale, String> param2, Map<Locale, String> param3, String param4, ServiceContext param5)
        throws PortalException, SystemException
    {
