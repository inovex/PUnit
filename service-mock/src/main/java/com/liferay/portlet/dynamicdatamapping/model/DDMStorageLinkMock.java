 ...
 * 
 */
public class DDMStorageLinkMock
    extends MockService<DDMStorageLink>
    implements DDMStorageLink
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.dynamicdatamapping.model.DDMStorageLink.class));
    }
    ...
    public int compareTo(DDMStorageLink param0) {
    ...
    public long getStorageLinkId() {
        return this.mockObject.getStorageLinkId();
    }
