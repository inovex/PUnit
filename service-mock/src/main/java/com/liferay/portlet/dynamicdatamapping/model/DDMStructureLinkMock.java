 ...
 * 
 */
public class DDMStructureLinkMock
    extends MockService<DDMStructureLink>
    implements DDMStructureLink
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.dynamicdatamapping.model.DDMStructureLink.class));
    }

    public DDMStructure getStructure()
        throws PortalException, SystemException
    {
        return this.mockObject.getStructure();
    }
    ...
    public int compareTo(DDMStructureLink param0) {
    ...
    public void setStructureLinkId(long param0) {
    }

    public long getStructureLinkId() {
        return this.mockObject.getStructureLinkId();
    }
