 ...
 * 
 */
public class MDRRuleGroupMock
    extends MockService<MDRRuleGroup>
    implements MDRRuleGroup
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.mobiledevicerules.model.MDRRuleGroup.class));
    }

    public List<MDRRule> getRules()
        throws SystemException
    {
        return this.mockObject.getRules();
    }
    ...
    public int compareTo(MDRRuleGroup param0) {
