 ...
 * 
 */
public class MDRRuleMock
    extends MockService<MDRRule>
    implements MDRRule
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.mobiledevicerules.model.MDRRule.class));
    }
    ...
    public int compareTo(MDRRule param0) {
    ...
    public long getRuleId() {
        return this.mockObject.getRuleId();
    }

    public void setRuleId(long param0) {
    }
