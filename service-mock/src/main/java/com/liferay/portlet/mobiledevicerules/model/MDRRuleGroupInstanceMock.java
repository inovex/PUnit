 ...
 * 
 */
public class MDRRuleGroupInstanceMock
    extends MockService<MDRRuleGroupInstance>
    implements MDRRuleGroupInstance
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.mobiledevicerules.model.MDRRuleGroupInstance.class));
    }

    public List<MDRAction> getActions()
        throws SystemException
    {
        return this.mockObject.getActions();
    }

    public MDRRuleGroup getRuleGroup()
        throws PortalException, SystemException
    {
        return this.mockObject.getRuleGroup();
    }
    ...
    public int compareTo(MDRRuleGroupInstance param0) {
