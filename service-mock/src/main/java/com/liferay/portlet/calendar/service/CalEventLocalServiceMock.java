    ...
    implements CalEventLocalService
{
    ...
    public CalEvent deleteEvent(CalEvent param0)
        throws PortalException, SystemException
    {
        return this.mockObject.deleteEvent(param0);
    }

    public CalEvent deleteEvent(long param0)
        throws PortalException, SystemException
    {
        return this.mockObject.deleteEvent(param0);
    }
    ...
    public File exportEvents(long param0, List<CalEvent> param1, String param2)
        throws PortalException, SystemException
    {
        return this.mockObject.exportEvents(param0, param1, param2);
    }
    ...
    public CalEvent updateEvent(long param0, long param1, String param2, String param3, String param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, boolean param12, boolean param13, String param14, boolean param15, TZSRecurrence param16, int param17, int param18, int param19, ServiceContext param20)
        throws PortalException, SystemException
    {
        return this.mockObject.updateEvent(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18, param19, param20);
    }
    ...
    public CalEvent addEvent(long param0, String param1, String param2, String param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, boolean param11, boolean param12, String param13, boolean param14, TZSRecurrence param15, int param16, int param17, int param18, ServiceContext param19)
        throws PortalException, SystemException
    {
        return this.mockObject.addEvent(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18, param19);
    }
    ...
    public CalEvent fetchCalEventByUuidAndCompanyId(String param0, long param1)
        throws SystemException
    {
        return this.mockObject.fetchCalEventByUuidAndCompanyId(param0, param1);
    }

    public CalEvent fetchCalEventByUuidAndGroupId(String param0, long param1)
        throws SystemException
    {
        return this.mockObject.fetchCalEventByUuidAndGroupId(param0, param1);
    }

    public CalEvent getCalEventByUuidAndCompanyId(String param0, long param1)
        throws PortalException, SystemException
    {
        return this.mockObject.getCalEventByUuidAndCompanyId(param0, param1);
    }
