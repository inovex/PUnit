 ...
 * 
 */
public class SCProductScreenshotMock
    extends MockService<SCProductScreenshot>
    implements SCProductScreenshot
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.softwarecatalog.model.SCProductScreenshot.class));
    }
    ...
    public int compareTo(SCProductScreenshot param0) {
    ...
    public long getThumbnailId() {
        return this.mockObject.getThumbnailId();
    }

    public void setThumbnailId(long param0) {
    }

    public long getFullImageId() {
        return this.mockObject.getFullImageId();
    }
