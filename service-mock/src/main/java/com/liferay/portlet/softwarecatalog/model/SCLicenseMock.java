 ...
 * 
 */
public class SCLicenseMock
    extends MockService<SCLicense>
    implements SCLicense
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.softwarecatalog.model.SCLicense.class));
    }
    ...
    public int compareTo(SCLicense param0) {
    ...
    public boolean getOpenSource() {
        return this.mockObject.getOpenSource();
    }

    public boolean isOpenSource() {
        return this.mockObject.isOpenSource();
    }
    ...
    public boolean isRecommended() {
        return this.mockObject.isRecommended();
    }
