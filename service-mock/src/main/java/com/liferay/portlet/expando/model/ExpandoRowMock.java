 ...
 * 
 */
public class ExpandoRowMock
    extends MockService<ExpandoRow>
    implements ExpandoRow
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.expando.model.ExpandoRow.class));
    }
    ...
    public int compareTo(ExpandoRow param0) {
