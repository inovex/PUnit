 ...
 * 
 */
public class ExpandoTableMock
    extends MockService<ExpandoTable>
    implements ExpandoTable
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.expando.model.ExpandoTable.class));
    }

    public boolean isDefaultTable() {
        return this.mockObject.isDefaultTable();
    }
    ...
    public int compareTo(ExpandoTable param0) {
