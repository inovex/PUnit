 ...
 * 
 */
public class WikiPageResourceMock
    extends MockService<WikiPageResource>
    implements WikiPageResource
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.wiki.model.WikiPageResource.class));
    }
    ...
    public int compareTo(WikiPageResource param0) {
