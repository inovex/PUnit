 ...
 * 
 */
public class DLFileRankMock
    extends MockService<DLFileRank>
    implements DLFileRank
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.documentlibrary.model.DLFileRank.class));
    }
    ...
    public int compareTo(DLFileRank param0) {
    ...
    public long getFileRankId() {
        return this.mockObject.getFileRankId();
    }
