 ...
 * 
 */
public class DLFileEntryMetadataLocalServiceMock
    extends MockService<DLFileEntryMetadataLocalService>
    implements DLFileEntryMetadataLocalService
{

    private HashMap<Long, DLFileEntryMetadata> _serviceObjects = new HashMap<Long, DLFileEntryMetadata>();

    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.documentlibrary.service.DLFileEntryMetadataLocalService.class));
    }
    ...
    public DLFileEntryMetadata createDLFileEntryMetadata(long param0) {
    ...
    public int getDLFileEntryMetadatasCount()
        throws SystemException
    {
        return this.mockObject.getDLFileEntryMetadatasCount();
    }

    public DLFileEntryMetadata updateDLFileEntryMetadata(DLFileEntryMetadata param0)
        throws SystemException
    {
    ...
    public DLFileEntryMetadata getFileEntryMetadata(long param0)
        throws PortalException, SystemException
    {
        return this.mockObject.getFileEntryMetadata(param0);
    }

    public DLFileEntryMetadata getFileEntryMetadata(long param0, long param1)
        throws PortalException, SystemException
    {
        return this.mockObject.getFileEntryMetadata(param0, param1);
    }

    public long getFileEntryMetadataCount(long param0, long param1)
        throws SystemException
    {
