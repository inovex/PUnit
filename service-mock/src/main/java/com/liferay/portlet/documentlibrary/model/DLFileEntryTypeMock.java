 ...
 * 
 */
public class DLFileEntryTypeMock
    extends MockService<DLFileEntryType>
    implements DLFileEntryType
{


    public void initMockObject() {
        this.setMockObject(org.mockito.Mockito.mock(com.liferay.portlet.documentlibrary.model.DLFileEntryType.class));
    }

    public List<DDMStructure> getDDMStructures()
        throws SystemException
    {
        return this.mockObject.getDDMStructures();
    }

    public boolean isExportable() {
        return this.mockObject.isExportable();
    }
    ...
    public int compareTo(DLFileEntryType param0) {
    ...
    public void setFileEntryTypeKey(String param0) {
    }

    public String getFileEntryTypeKey() {
        return this.mockObject.getFileEntryTypeKey();
    }
