 ...
 * 
 */
public class DLFileEntryMetadataMock
    extends MockService<DLFileEntryMetadata>
    implements DLFileEntryMetadata
{
    ...
    public int compareTo(DLFileEntryMetadata param0) {
    ...
    public long getFileEntryMetadataId() {
        return this.mockObject.getFileEntryMetadataId();
    }

    public void setFileEntryMetadataId(long param0) {
    }
