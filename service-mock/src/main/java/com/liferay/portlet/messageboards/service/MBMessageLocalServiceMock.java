    ...
    implements MBMessageLocalService
{
    ...
    public long moveMessageAttachmentToTrash(long param0, long param1, String param2)
        throws PortalException, SystemException
    {
        return this.mockObject.moveMessageAttachmentToTrash(param0, param1, param2);
    }

    public void restoreMessageAttachmentFromTrash(long param0, long param1, String param2)
        throws PortalException, SystemException
    {
    }
    ...
    public MBMessage addMessage(long param0, String param1, long param2, String param3, String param4, ServiceContext param5)
        throws PortalException, SystemException
    {
        return this.mockObject.addMessage(param0, param1, param2, param3, param4, param5);
    }
    ...
    public MBMessage deleteDiscussionMessage(long param0)
        throws PortalException, SystemException
    {
        return this.mockObject.deleteDiscussionMessage(param0);
    }
    ...
    public MBMessage deleteMessage(MBMessage param0)
        throws PortalException, SystemException
    {
        return this.mockObject.deleteMessage(param0);
    }

    public MBMessage deleteMessage(long param0)
        throws PortalException, SystemException
    {
        return this.mockObject.deleteMessage(param0);
    }

    public void deleteMessageAttachment(long param0, String param1)
        throws PortalException, SystemException
    {
    }

    public void deleteMessageAttachments(long param0)
        throws PortalException, SystemException
    {
    }
    ...
    public MBMessage fetchMBMessageByUuidAndCompanyId(String param0, long param1)
        throws SystemException
    {
        return this.mockObject.fetchMBMessageByUuidAndCompanyId(param0, param1);
    }

    public MBMessage fetchMBMessageByUuidAndGroupId(String param0, long param1)
        throws SystemException
    {
        return this.mockObject.fetchMBMessageByUuidAndGroupId(param0, param1);
    }

    public MBMessage getMBMessageByUuidAndCompanyId(String param0, long param1)
        throws PortalException, SystemException
    {
        return this.mockObject.getMBMessageByUuidAndCompanyId(param0, param1);
    }
